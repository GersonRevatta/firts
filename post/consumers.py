...
# routing.py.
def connect_blog(message,id_video, slug):
    """
...
def disconnect_blog(message,id_video, slug):
    """
...
def save_post(message,id_video, slug):
    """
    ...
    Post.objects.create(liveblog=liveblog, body=data['message'],handle=data['handle'])
